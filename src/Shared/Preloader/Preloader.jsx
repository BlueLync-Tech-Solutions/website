...
const Preloader = () => {
  ...
  useEffect(() => {
    ...
    function startStrokeAnimation() {
      // Optional: add custom animation here
    }
  }, []);
  ...
  //     ref={preloaderRef}
  //   >
  //     {/* 🔸 Orange background SVG instead of blue */}
  //     <svg
  //       viewBox='0 0 1000 1000'
  //       preserveAspectRatio='none'
  //       className='absolute top-0 w-screen h-[110vh] fill-[#ff7f00]'
  //     >
  //       <path
  //         id='preloaderSvg'
  //         ref={svgRef}
  ...
  //     <div className='preloader-heading'>
  //       {/* 🔸 Orange text instead of white */}
  //       <div className='text-[26px] font-light tracking-[35px] uppercase font-Rajdhani text-[#ff7f00] z-20 load-text'>
  //         {['L', 'o', 'a', 'd', 'i', 'n', 'g'].map((char, index) => (
  //           <span
  //             key={index}
  //             className='animate-pulse'

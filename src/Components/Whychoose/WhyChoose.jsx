...
// Avinash Commented
  ...
  //                   required
  //                   className='w-[520px] xl:w-[400px] 2xl:w-[520px] h-[65px] rounded-full text-xl font-medium border border-white px-10 py-3 outline-none text-[#0D47A1] font-Rajdhani placeholder:text-[#0D47A1] bg-white bg-opacity-10 backdrop-filter backdrop-blur-[5px]'
  //                 />
  //                 <button
  //                   type='submit'

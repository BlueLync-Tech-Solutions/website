...
const Pricing = () => {
  ...
  //             onClick={togglePlans}
  //           >
  //             <div className='font-Rajdhani font-semibold text-[#0D47A1] text-lg sm:text-[19px]'>
  //               Monthly
  //             </div>
  //             <div
  ...
  //               <h5 className='font-Rajdhani font-semibold text-2xl leading-4 text-[#0D47A1]'>
  //                 Basic Plan
  //               </h5>
  //               <div className='flex items-center gap-1 mb-[2px]'>
  //                 <h6 className='font-Rajdhani font-semibold text-2xl xl:text-3xl text-[#0D47A1] relative -top-2'>
  //                   $
  //                 </h6>
  //                 <div className='font-Rajdhani text-[42px] sm:text-[50px] xl:text-[60px] text-[#0D47A1] font-semibold'>
  //                   <OnScrollCounter
  //                     start={0}
  //                     end={30}
  //                     duration={1000}
  //                   />
  //                 </div>
  //                 <p className='font-Nunito text-[#0D47A1] sm:ml-3'>
  ...
  //               <Link
  //                 to={'/'}
  //                 className='mt-3 bg-HeadingColor-0 bg-opacity-10 group text-[#0D47A1] transition-all duration-500 hover:text-white pricing-btn font-Rajdhani flex items-center gap-2 justify-center font-semibold text-center w-full uppercase py-3 px-7 rounded-full overflow-hidden relative z-10 before:absolute before:top-0 before:right-0 before:bg-gradient-to-r before:ease-linear before:to-PrimaryColor2-0 before:from-PrimaryColor3-0 before:w-0 before:h-full before:transition-all before:duration-300 before:-z-10 hover:before:w-full hover:before:left-0'
  //               >
  //                 Download Info
  //                 <span className='icon-style'>
  //                   <svg
  //                     className='qodef-svg--custom-arrow qodef-m-arrow inline-block text-[#0D47A1] h-[10px] group-hover:text-white w-auto transition-all duration-500'
  //                     xmlns='http://www.w3.org/2000/svg'
  //                     stroke='CurrentColor'
  //                     width='14.2'
  //                     height='14.2'
  ...
  //                 Features
  //               </h5>
  //               <p className='font-Nunito text-[#0D47A1] text-[15px] mb-[18px]'>
  //                 Everything in your basic plans
  //               </p>
  //               <ul className='space-y-2'>
  //                 <li className='flex items-center gap-2 font-Nunito text-[#0D47A1]'>
  //                   <FaRegCircleCheck
  //                     size={18}

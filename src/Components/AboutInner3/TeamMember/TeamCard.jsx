  ...
  return (
    <div className='group relative p-2 sm:p-[30px] bg-white rounded-[10px]'>
      ...
      <div className="bg-transparent relative transition-all duration-500 rounded-md text-center pt-3 sm:pt-[22px] rounded-b-md">
        <h5 className='font-Rajdhani font-semibold text-2xl sm:text-[28px] text-[#0D47A1] transition-all duration-500'>
          {teamTitle}
        </h5>
        <p className='font-Nunito text-[#0D47A1] transition-all duration-500 mt-1'>
          {teamDesc}
        </p>
      </div>
    </div>

...
const CallDoAction = () => {
  ...
  //             />
  //           </h5>
  //           <h1 className='font-Rajdhani font-bold text-lg leading-6 sm:text-[32px] sm:leading-[40px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-[#0D47A1] mt-[14px] mb-3'>
  //             Do You Want to Take Your Business to
  //             <br /> Next Level? Connect with Us
  //           </h1>
  //           <p className='font-Nunito text-[#0D47A1] max-w-[590px] w-full mx-auto mb-8'>

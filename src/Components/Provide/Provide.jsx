...
const Provide = () => {
  ...
  //           />
  //         </h5>
  //         <h1 className='font-Rajdhani font-bold text-lg leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-[#0D47A1] mt-[18px]'>
  ...
  //                 />
  //               </div>
  //               <h5 className='flex-1 font-Rajdhani font-semibold text-lg sm:text-[22px] lg:text-lg xl:text-[19px] 2xl:text-[22px] leading-6 sm:leading-7 text-[#0D47A1]'>

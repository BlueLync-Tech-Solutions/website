...
const Blog = () => {
  ...
  return (
    <section className='pt-10 md:pt-10 lg:pt-10 bg-BodyBg-0' style={{'padding-bottom':'120px'}}>
      <div className='Container'>
        <div className='flex gap-4 flex-col md:flex-row justify-between items-center'>
          <div>
            ...
            <h1 className='font-Rajdhani font-bold text-xl leading-7 sm:text-[34px] sm:leading-[44px] md:text-[38px] md:leading-[48px] lg:text-[30px] lg:leading-[40px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-[#0D47A1] mt-[14px] mb-4'>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <p className="font-Nunito text-[#1A237E] text-base sm:text-lg mb-6 leading-relaxed">
              At SAI IT, we don’t just build technology — we craft experiences. 
              From startups to enterprises, our mission is to empower brands 
              with smart digital ecosystems that evolve, adapt, and inspire.
            </p>

            <p className="font-Nunito text-[#1A237E] text-base sm:text-lg mb-8 leading-relaxed">
              We bring together passionate engineers, designers, and strategists 
              who thrive on innovation, crafting solutions that drive measurable impact 
